...
screen = pygame.display.set_mode((700,750), pygame.FULLSCREEN) #allows fullscreen #comment this line out for smaller window
handler = imageHandler()

def display():
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/1.jpg", "1" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON//AIGENT/animation/2.jpg", "2" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/3.jpg", "3" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/4.jpg", "4" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/5.jpg", "5" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/6.jpg", "6" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/7.jpg", "7" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/8.jpg", "8" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/9.jpg", "9" ) #add your own file location here
    handler.loadFromFile ( "D:/PROGRAMMING/PYTHON/AIGENT/animation/10.jpg", "10" ) #add your own file location here
display()
