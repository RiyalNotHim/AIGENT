...
class AnimatedGIF(tk.Label):
    def _init_(self, master, paths):
        ...
        super()._init_(master, image=self.current_frame)
...
def open_third_screen():
    ...
    gif_label = AnimatedGIF(third_window, ["D:\PROGRAMMING\PYTHON\AIGENT\waves1.gif"])  # Change path accordingly
...
gif_label = AnimatedGIF(root, ["D://PROGRAMMING//PYTHON//AIGENT//initgif.gif", "D://PROGRAMMING//PYTHON//AIGENT//aig.gif"])  # Change paths accordingly
gif_label.pack(fill=tk.BOTH, expand=True)
