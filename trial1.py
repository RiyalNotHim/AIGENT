...
#     pass
    ...
    # clock_label.place(relx=0.95, rely=0.1, anchor="ne")  
    # # Place in top right corner but a little lower and to the left
    # update_clock(clock_label)  # Start updating the clock
    
#     # txt = 

# def text(third_window,txt):
#         example_text=txt
#         text_field = tk.Text(third_window, font=("Helvetica", 12), width=40, height=2, bg="black", fg="white", borderwidth=0, highlightthickness=0)
#         text_field.place(relx=0, rely=1, anchor="sw")  # Position at the center
#         text_field.insert(tk.END, example_text)
